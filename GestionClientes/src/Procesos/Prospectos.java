...
public class Prospectos extends JDialog {
	...
	public Prospectos() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Prospectos.class.getResource("/Imagenes/Prospecto.png")));
		setBounds(100, 100, 771, 618);
		getContentPane().setLayout(null);
		
		JPanel panel = new JPanel();
		panel.setBounds(10, 11, 504, 200);
		panel.setToolTipText("dddd");
		getContentPane().add(panel);
		panel.setLayout(null);
		
		JLabel lblNewLabel = new JLabel("Contacto");
		lblNewLabel.setBounds(10, 31, 77, 14);
		panel.add(lblNewLabel);
		
		txtContacto = new JTextField();
		txtContacto.setBounds(132, 28, 347, 20);
		panel.add(txtContacto);
		txtContacto.setColumns(10);
		
		JLabel lblNewLabel_1 = new JLabel("Empresa");
		lblNewLabel_1.setBounds(10, 62, 77, 14);
		panel.add(lblNewLabel_1);
		
		txtEmpresa = new JTextField();
		txtEmpresa.setBounds(132, 59, 347, 20);
		...
		txtCargo.setBounds(131, 90, 241, 20);
		panel.add(txtCargo);
		...
		txtTelefono.setBounds(131, 121, 124, 20);
		...
		txtCorreo.setBounds(132, 152, 268, 20);
		panel.add(txtCorreo);
		...
		btnGuardar.setIcon(new ImageIcon(Prospectos.class.getResource("/Imagenes/Guardar.png")));
		...
		btnSalir.setIcon(new ImageIcon(Prospectos.class.getResource("/Imagenes/Salir.png")));
		getContentPane().add(btnSalir);
		
		txtStatus = new JTextField();
		txtStatus.setBounds(10, 225, 745, 20);
		getContentPane().add(txtStatus);
		txtStatus.setColumns(10);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);
		scrollPane.setBounds(10, 256, 745, 275);
